...
archivo_url = pd.read_excel('/dbfs/mnt/adls/inmuebles/Logs/General/URL_Busqueda.xlsx', sheet_name="Finca_Raiz")
...
for pagina in url_paginas:
    for id_pagina in range(0,201): #Cambiar el 201 por 401
...
filtro = "inmueble"
url_inmuebles = [url for url in url_inmuebles if url is not None and filtro in url]
